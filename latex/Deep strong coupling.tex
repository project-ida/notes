...
because the large dissipation sucks out the energy before any transfer
can occur.
...
characterised by \(\omega_{\rm exchange} = \omega_+ \times k/2m\). This
...
interacting with a a single mode (i.e.~single frequency/wavelength) of a
