...
These notes build a toy nuclear model from explicit pion exchange to
magnetic coupling between pion-dressed nuclear states. In particular,
we:
...
\item
  integrate out the pionful doorway sector to obtain low-energy
  effective nuclear Hamiltonians,
\item
  diagonalise those effective Hamiltonians to identify the pion-dressed
  nuclear states,
\item
  track how the magnetic operator couples those dressed states rather
  than the original bare states,
\item
  work through a concrete single-nucleus spin-based instantiation of the
  general model,
\item
  extend the construction to two coupled model nuclei and derive the
  corresponding \(4\times4\) effective Hamiltonian,
\item
  keep the Bloch-Horowitz energy dependence explicit where needed, so
  that the dressed two-nucleus energies are not simply given by naive
  sums of single-nucleus energies,
\item
  use those dressed energies as preparation for later
  excitation-transfer questions, since it is the pion-generated levels
  that are subsequently coupled by the magnetic interaction.
\end{enumerate}

The goal is pedagogical rather than realistic. We keep the strong
dynamics schematic, but the logic of the reduction is made as explicit
as possible. In particular, we do \textbf{not} yet try to identify the
states with realistic deuteron channels. The aim is first to understand
how pion exchange can generate nuclear levels and how magnetic couplings
act between those generated levels, before moving on to more realistic
models.

Throughout, we set \(\hbar = 1\).

\section{Degrees of freedom and physical
...
\section{Full toy Hamiltonian}\label{full-toy-hamiltonian}
...
\section{Retained and eliminated
...
\section{Second-order elimination of the pionful
...
\section{Magnetic operator in the dressed
...
\section{Final post-pion Hamiltonian with the photon still
...
\section{Special case: a degenerate spin-up / spin-down
...
\section{Two model nuclei and the excitation-transfer
...
\subsection{Retained and pion states}\label{retained-and-pion-states}
...
\subsection{Full block Hamiltonian}\label{full-block-hamiltonian}
...
\subsection{Bloch-Horowitz elimination of the pion
...
\subsection{Diagonalisation: bright and dark states on each
...
\subsection{Symmetric limit}\label{symmetric-limit}
...
\subsection{Rotating the magnetic
...
\subsection{Symmetric-coupling limit of the magnetic
...
\subsection{Symmetric limit for identical
...
\subsection{Solving for the actual low-energy
...
\subsubsection{Exact quadratic
equations}\label{exact-quadratic-equations}
...
\subsubsection{Small-parameter
expansion}\label{small-parameter-expansion}
...
\subsubsection{Energy differences}\label{energy-differences}
...
\subsubsection{\texorpdfstring{Writing the asymmetry in terms of
